# How to Publish @oshan/tourneytree to NPM
...
# For scoped packages (like @oshan/tourneytree), make sure it's public
npm publish --access public
```

### Step 7: Verify Publication
1. Check on NPM website: `https://www.npmjs.com/package/@oshan/tourneytree`
2. Install in a test project: `npm install @oshan/tourneytree`

## Important Notes

### Package Name Requirements
- Your package name `@oshan/tourneytree` is a **scoped package**
...
- **NPM Registry**: `https://www.npmjs.com/package/@oshan/tourneytree`
- **Installation**: `npm install @oshan/tourneytree`
- **CDN**: `https://unpkg.com/@oshan/tourneytree`
